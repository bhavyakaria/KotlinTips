...
2. Unlike Java, arrays are invariant in Kotlin. This means that Kotlin does not let us assign an Array to an Array, which prevents a possible runtime failure.
